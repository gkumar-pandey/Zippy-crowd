...
export const MemberSection = () => {
    ...
    return (
        <section className={`pt-12 pb-6 bg-[#F3F4FF] mt-02 `}>
            <Container>
                <div
                    className={`${styles.member} ${styles.memberSection} relative px-[15px]`}
                >
                    <div>
                        <Animate.FadeIn>
                            ...
                            <div>
                                <div className="sm:w-full  flex flex-col justify-between mb-[42px]  ">
                                    <h1 className="2xl:text-[40px] text-[33px] sm:text-[28px] font-semibold mb-[30px] w-8/12 2xl:w-7/12 md:w-10/12 sm:w-full ">
                                        Why spend time promoting what you do,
                                        when you can spend time doing what you
                                        love.
                                    </h1>
                                    <div className=" w-8/12 2xl:w-7/12 md:w-10/12 sm:w-full">
                                        <Text variant="text">
                                            ZippyCrowd saves time, money and
                                            effort on digital marketing, giving
                                            you the freedom to concentrate on
                                            what you do best as a…
                                        </Text>
                                    </div>
                                </div>
                            </div>
